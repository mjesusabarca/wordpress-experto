...
### Front End Avanzado (I)

 * Customizer en themes
 * Customizer en plugins
 * Templates propios en plugins
 ...
 * Must-Use Plugins
 * Procesos de activación, desactivación y desinstalación
 * Transients
 ...
 * Registro dinámico de Post Types
 * Registro dinámico de taxonomías
 ...
 * Git submodules (repositorios)
 * Composer (librerías PHP)
 * Bower (librerías HTML/CSS/JS)
...
## Intro a patrones de diseño en PHP
